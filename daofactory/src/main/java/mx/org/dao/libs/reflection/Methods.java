package mx.org.dao.libs.reflection;
...
public final class Methods {
  ...
  public static Object getAttributeValue(Class clase, String name) throws NoSuchFieldException, IllegalAccessException {
    Object regresar = null;
    Field campo     = null;
    if(name!= null && name.trim().length()> 0) {
      campo = clase.getDeclaredField(name);
      regresar= campo.get(campo);
    } // if
    return regresar;
  }

  //trae el valor de un atributo de un objeto instanciado
  public static Object getAttributeValue(Object clase, String name) throws NoSuchFieldException, IllegalAccessException {
    Object regresar = null;
    Field campo     = null;
    if(name!= null && name.trim().length()> 0) {
      campo = clase.getClass().getDeclaredField(name);
      regresar= campo.get(clase);
    } // if
    return regresar;
  }
